        ...
        try {
            ...
            if (response.ok) {
                if (data.user.role === 'ADMIN') {
                    toast.error("Kartu ini milik Admin. Silakan login di panel Admin.", { id: 'qr-login-error' });
                ...
                toast.success(`Berhasil login via Kartu Member! Halo, ${data.user.name} 👋`, { id: 'qr-login-success' });
                navigate('/user/dashboard/discover');
            } else {
